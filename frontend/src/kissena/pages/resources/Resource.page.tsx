...
const resources = [
  ...
  },
  {
    ...
    description: "Learn the basics of Python programming with examples and tutorials.",
    tags: [
      { id: "t4", title: "Python", color: "#306998" },
      { id: "t2", title: "Programming", color: "#4caf50" },
      { id: "t5", title: "Data Science", color: "#ff9800" }
  ...
  },
  {
    ...
    description: "A hands-on guide to mastering CSS Flexbox and Grid layout systems.",
    tags: [
      { id: "t6", title: "CSS", color: "#264de4" },
      { id: "t7", title: "Web Design", color: "#e91e63" }
    ],
  ...
  },
  {
    ...
    description: "Ensure your website is accessible to everyone by following best practices.",
    tags: [
      { id: "t12", title: "Accessibility", color: "#9c27b0" },
      { id: "t7", title: "Web Design", color: "#e91e63" }
    ],
  ...
  },
  {
    ...
    description: "Explore deep learning concepts and build models using PyTorch.",
    tags: [
      { id: "t8", title: "Machine Learning", color: "#f44336" },
      { id: "t15", title: "PyTorch", color: "#e53e3e" }
    ],
  ...
  },
  {
    ...
    description: "Learn how to deploy and manage containerized applications with Kubernetes.",
    tags: [
      { id: "t13", title: "Docker", color: "#0db7ed" },
      { id: "t14", title: "DevOps", color: "#9c27b0" },
      { id: "t16", title: "Kubernetes", color: "#326ce5" }
  ...
  },
  {
    ...
    description: "A guide to creating and using REST APIs with Node.js and Express.",
    tags: [
      { id: "t1", title: "JavaScript", color: "#f0db4f" },
      { id: "t17", title: "Node.js", color: "#8cc84b" }
    ],
  ...
  },
  {
    ...
    description: "Master Git for version control and collaboration in software development.",
    tags: [
      { id: "t19", title: "Git", color: "#f1502f" },
      { id: "t2", title: "Programming", color: "#4caf50" }
    ],
  ...
  },
  {
    ...
    description: "Learn how to create responsive websites using the Bootstrap framework.",
    tags: [
      { id: "t6", title: "CSS", color: "#264de4" },
      { id: "t7", title: "Web Design", color: "#e91e63" }
    ],
  ...
  },
  {
    ...
    description: "Learn the fundamentals of web security and how to protect your site from threats.",
    tags: [
      { id: "t22", title: "Web Security", color: "#9c27b0" },
      { id: "t7", title: "Web Design", color: "#e91e63" }
    ],
