  ...
  return (
    ...
    >
      ...
      <Group h={'20rem'} w={'100%'} wrap="nowrap" visibleFrom="sm">
        ...
        <Stack
          h={'100%'}
          bg={resolveTeamColor(props.team)}
          w="auto"
          pl={'2rem'}
          pr={'2.3rem'}
          c={'lightYellow.1'}
          ...
          align="center"
        >
          <Title order={2} fw={200} tt={'uppercase'}>
            {weekday}
          </Title>
        ...
        >
          <Stack gap={'0.25rem'}>
            <Text ml={'auto'} size="md" c={'lightYellow.1'} fw={400}>
              {dateExpanded}
            </Text>
            <Group>
            ...
            <Title hiddenFrom="md" order={3} c={'neonGreen.6'} lineClamp={3}>
              {props.title}
            </Title>
            <Text size="lg" c={'neonGreen.9'}>
              {props.location}
            </Text>
            <Box flex={1}>
              <Text lineClamp={3} c="lightYellow.1">
                {props.description ?? ''}
              </Text>
            </Box>
          </Stack>
      ...
      >
        <Group gap={'1rem'} wrap="nowrap" align="flex-start">
          <Stack
            ...
            align="center"
          >
            <Title order={3} fw={200} tt={'uppercase'}>
              {weekday}
            </Title>
          ...
          <Stack flex={1} gap={0}>
            ...
            <Title order={4} c={'neonGreen.6'} lineClamp={3}>
              {props.title}
            </Title>
            <Title order={4} c={'neonGreen.9'} fw={400} lineClamp={3}>
              {props.location}
            </Title>
          </Stack>
        </Group>
        <Text c="lightYellow.1" lineClamp={10}>
          {props.description ?? ''}
        </Text>
        <Text
          hidden={!props.partner || props.team !== 'partner'}
          c="lightYellow.1"
          fs={'italic'}
        >
          Partnered with {props.partner ?? ''}
        </Text>
        <Box hidden={!props.learnMoreUrl}>
          <a href={props.learnMoreUrl ?? ''}>
            <Button
